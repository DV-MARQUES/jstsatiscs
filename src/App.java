        ...
        do {
            ...
            switch (op) {
                ...
                case 4:
                    ...
                    StringBuilder listaAreas = new StringBuilder();
                    for(int i = 0; i < qtdArea; i++){
                        listaAreas.append(String.format("- Jardim %d: %d m²\n", i + 1, areas[i]));
                    }
                    ...
                    String mensagemAreas = "Lista de Areas:\n" +listaAreas.toString();        
                    JOptionPane.showMessageDialog(null, mensagemFinal);
                    JOptionPane.showMessageDialog(null, mensagemAreas);
